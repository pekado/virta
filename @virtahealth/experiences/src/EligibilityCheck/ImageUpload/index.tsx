...
export const ImageUpload: React.FC<ImageUploadProps> = ({
  ...
  return (
    <InsuranceHeadingContainer>
      ...
      <Spacer height={16} />
      <Body>{intl.formatMessage(messages.attachImageTroubleShooting)}</Body>
      <Spacer height={16} />
      <ul
        style={{
      ...
      >
        <li>
          <Body>{intl.formatMessage(messages.fileTypes)}</Body>
        </li>
        <li>
          <Body>{intl.formatMessage(messages.imageFileSize)}</Body>
        </li>
      </ul>
      <Spacer height={16} />
      <Body>
