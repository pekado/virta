...
`;
const BlueHeading2 = styled(Heading2)`
...
export const InsuranceHeading2 = isMobile ? MobileHeading2 : BlueHeading2;
...
export const EligibilityCheck: React.FC<EligibilityCheckProps> = ({
  ...
  React.useEffect(() => {
    ...
    setIsLoading(false);
  }, [coverage, eligibilityResponses, user]);
...
export const EligibilityCheckExperience = withVirta(EligibilityCheck);
