...
export const buttonBaseTextFontWeight = font.fontWeight6;
...
export const buttonTertiaryTextDecoration = textDecorationLine.underline;
...
export const buttonMediumTextFontSize = font.fontSize4;
