...
import { EligibilityCheckExperienceV2 } from "@virtahealth/experiences";
import { StoryBookVirtaContext } from "../utils/StoryBookVirtaContext";
import emptyVirtaClient from "../utils/emptyVirtaClient";

export default {
  title: "Experiences / EligibilityCheckExperienceV2",
  component: EligibilityCheckExperienceV2,
  parameters: {
    layout: "fullscreen",
  },
};
